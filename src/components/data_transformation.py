...
class DataTransformation:
    ...
    def get_data_transformer_object(self):
        ...
        try:
            ...
            logging.info(f"Categorical_columns:{categroical_columns}")
    ...
    def initiate_data_transformation(self,train_path,test_path):
        try:
            ...
            logging.info("Here read train & test data is done")
            ...
            logging.info("Applying preprocessing object on training datframe & testing dataframe")
